...
public class ScmInfoHolderImpl implements ScmInfoRepository {

  private static final Logger LOGGER = Loggers.get(ScmInfoHolderImpl.class);

  private final BatchReportReader batchReportReader;
  private final DbClient dbClient;
  private final SourceService sourceService;

  public ScmInfoHolderImpl(BatchReportReader batchReportReader, DbClient dbClient, SourceService sourceService) {
